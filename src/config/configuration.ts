export default () => {
  ...
  return {
    ...
    smtp: {
      ...
      from: process.env.SMTP_FROM || 'no-reply@visitmauritiusparadise.com',
      fromName: process.env.SMTP_FROM_NAME || 'Visit Mauritius Paradise',
      adminEmail: process.env.SMTP_ADMIN_EMAIL || process.env.ADMIN_EMAIL || '',
    },
  };
};
